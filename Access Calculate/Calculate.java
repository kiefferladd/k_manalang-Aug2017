...
public class Calculate {
	...
	/*Divides the Radius of the circle to pi.*/
	public static double toDegrees (double angleradians) {
		return  angleradians * (180/3.14159);
	}

	/*Measures based on the Radius of the circle:*/
	public static double toRadians (double angledegrees) {
		return  angledegrees * (3.14159/180);
	}

	/*Discriminant reveals what type of roots the equation has.*/
	...
	/* To distribute two binomials*/
	public static String foil (int a, int b, int c, int d, String n) {
		String answer = (a*c) +n+"^2+" + ((a*d)+(b*c))+n+"+"+(b*d);
		return answer;
	}

	/*Checks if the number can be divided by another number results in a whole number*/
	...
	/*Checks the number if it's 0 or not*/
	...
	/*Takes the number to it's simplest form*/
	...
	/*Checks the result of multiplying a sequence of descending natural numbers down to 1 */
	...
	/* Checks if a whole number must be greater than 1.*/
	...
	/*Checks the the highest number that divides exactly into two or more numbers.*/
